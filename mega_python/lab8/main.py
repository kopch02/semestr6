from flask import Flask, url_for, render_template, redirect, send_from_directory, abort, request, jsonify, make_response
from flask_login import LoginManager, login_user, login_required, logout_user, current_user
from flask_restful import Api
from data import db_session
from data.users import User
from data.jobs import Jobs, Categories, Link
...
import jobs_api
import users_resurses
import jobs_resurses
...
def main():
    ...
    # для списка объектов
    api.add_resource(users_resurses.UsersListResource, '/api/v2/users')

    # для одного объекта
    api.add_resource(users_resurses.UsersResource,
                     '/api/v2/users/<int:users_id>')

    # для списка объектов
    api.add_resource(jobs_resurses.jobListResource, '/api/v2/jobs')

    # для одного объекта
    api.add_resource(jobs_resurses.jobResource, '/api/v2/jobs/<int:job_id>')
